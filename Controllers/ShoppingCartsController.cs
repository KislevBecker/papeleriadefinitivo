...
namespace ProgramaDeRequisas.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,cantidad")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,cantidad")] ShoppingCart shoppingCart)
        {
            if (ModelState.IsValid)
            {
